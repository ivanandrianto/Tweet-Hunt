      ...
      <div class="carousel-inner" role="listbox">
			...
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-4 col-md-4">
						<img class="img-responsive" src="img/Ivan.jpg" width="300" style="padding-top:30px;">
					</div>
        ...
        <div class="item c1-2">
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-4 col-md-4">
						<img class="img-responsive" src="img/Wilhelm.jpg" width="300" style="padding-top:30px;">
					</div>
					<div class="col-xs-12 col-sm-8 col-md-8">
		...
		<div class="item c1-3">
			<div class="container">
				<div class="row">
					<div class="col-xs-12 col-sm-4 col-md-4">
						<img class="img-responsive" src="img/Freddy.jpg" width="300" style="padding-top:30px;">
					</div>
					<div class="col-xs-12 col-sm-8 col-md-8">
